Feature: Launches Page
  ...
  Scenario: user is able to see launches list sorted by most recent by default, and is able to resort them.
    When I save text of 'Launches Page > #1 of Launches' as 'launchName1'
      And I save text of 'Launches Page > #5 of Launches' as 'launchName2'
      And I click 'Launches Page > Page Header > Start Time'
      And I wait until text of 'Launches Page > #1 of Launches' not to be equal '$launchName1'
    Then I expect text of 'Launches Page > #5 of Launches' not to be equal '$launchName2'
      And I expect 'class' attribute of 'Launches Page > Page Header > Start Time' to contain 'sorting-active'
